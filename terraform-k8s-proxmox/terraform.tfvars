...
k8s_workers = {
 w1 = { target_node = "pve", vcpu = "4", memory = "4096", disk_size = "15", name = "k8sw1",notes = "Kubernetes Worker 1", ip = "192.168.15.222", gw = "192.168.15.1" },
 w2 = { target_node = "pve", vcpu = "4", memory = "4096", disk_size = "15", name = "k8sw2",notes = "Kubernetes Worker 2", ip = "192.168.15.223", gw = "192.168.15.1" },
