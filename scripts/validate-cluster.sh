...
echo ""
echo "Next steps:"
echo "  1. Apply MetalLB config: kubectl apply -f manifests/metallb-config.yaml"
echo "  2. Deploy test app: kubectl apply -f app_mario/app.yml"
echo "  3. Check services: kubectl get svc"
